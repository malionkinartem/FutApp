...
module.exports = {
    ...
    getSalePrice: function (analogicalItemsInTrade, itemPrice, maxPrice) {
        ...
        if (analogicalItemsInTrade === undefined || analogicalItemsInTrade.length == 0) {
            return { maxPrice: maxPrice, minPrice: itemPrice + interest };
        }
        ...
        maxPriceRanges.some(function (range) {
            if (range.length >= 2) {
                ...
                var minPrice = futApi.calculateNextHigherPrice(itemPrice + interest);
